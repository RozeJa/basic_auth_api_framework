...
@Service
@Repository("PrmissionAuthorizatinService")
public class PrmissionAuthorizatinService extends AuthorizationService {

    public PrmissionAuthorizatinService(IJwtService jwtService) {
        super(jwtService);
    }
